/* clarity-js v0.6.40: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get start() {
    ...
    function O(t, e) {
        Vr() && t && e && "string" == typeof t && "string" == typeof e && t.length < 255 && e.length < 255 && (E = {
            key: t,
            value: e
        }, Ja(24))
    }
    ...
    function A() {
        ...
        M = {
            gap: t - C
        }, Ja(25), M.gap < 3e5 ? z = D(A, j) : Pr && (O("clarity", "suspend"), ci(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function U(t) {
        Vr() && u.lean && (u.lean = !1, P = {
            key: t
        }, gr(), u.upgrade && u.upgrade(t), Ja(3))
    }
    var B = Object.freeze({
            __proto__: null,
            get data() {
    ...
    function _t() {
        ...
        t && (Ot = t, t.task().then((function() {
            ...
            t.id === hr() && (e && Ca(0, 1, e.name, e.message, e.stack), Ot = null, _t())
        })))
    }
            ...
            return $(this, (function(T) {
                switch (T.label) {
                    case 0:
                        ...
                        return [3, 10];
                    case 1:
                        return i = Lt, r.push(i.width), r.push(i.height), m(t, i.width, i.height), wa(r), [3, 10];
                    case 2:
                        for (o = 0, c = Un; o < c.length; o++) s = c[o], (r = [s.time, 7]).push(s.data.id), r.push(s.data.interaction), r.push(s.data.visibility), r.push(s.data.name), wa(r);
                        return na(), [3, 10];
                    case 3:
                    ...
                    case 6:
                        ...
                        for (g = p.data, y = p.metadata.active, w = p.metadata.suspend, k = p.metadata.privacy, E = function(t) {
                            ...
                            if (g[S = M[O]]) switch (S) {
                                case "tag":
                                    N = Ht(p), x = E ? -1 : 1, r.push(p.id * x), p.parent && y && r.push(p.parent), p.previous && y && r.push(p.previous), r.push(w ? "*M" : g[S]), N && 2 === N.length && r.push("".concat("#").concat(Yt(N[0]), ".").concat(Yt(N[1])));
                                    break;
                                case "attributes":
                                    for (_ in g[S]) void 0 !== g[S][_] && r.push(Wt(_, g[S][_], k));
                                    break;
                                case "value":
    ...
    function Oe(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== ke && null !== we.start && n !== e.anchorNode && (I(Ee), Me(21)), we = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, ke = e, I(Ee), Ee = D(Me, 500, 21)
        }
    }
    ...
    function Le(t) {
        ! function(t) {
            ...
            jr(t, "cut", $t.bind(this, 0), !0), jr(t, "copy", $t.bind(this, 1), !0), jr(t, "paste", $t.bind(this, 2), !0)
        }(t), function(t) {
            jr(t, "mousedown", se.bind(this, 13, t), !0), jr(t, "mouseup", se.bind(this, 14, t), !0), jr(t, "mousemove", se.bind(this, 12, t), !0), jr(t, "wheel", se.bind(this, 15, t), !0), jr(t, "dblclick", se.bind(this, 16, t), !0), jr(t, "touchstart", le.bind(this, 17, t), !0), jr(t, "touchend", le.bind(this, 18, t), !0), jr(t, "touchmove", le.bind(this, 19, t), !0), jr(t, "touchcancel", le.bind(this, 20, t), !0)
        }(t), function(t) {
            jr(t, "input", ae, !0)
        }(t), function(t) {
            jr(t, "selectstart", Oe.bind(this, t), !0), jr(t, "selectionchange", Oe.bind(this, t), !0)
        }(t), function(t) {
            jr(t, "submit", Te, !0)
        }(t))
    }
    var Ae = Object.freeze({
            __proto__: null,
            start: function() {
                oa = [], ca(), Kt(), te(), he(), ie(), jr(window, "resize", pe), pe(), jr(document, "visibilitychange", je), je(), ge = [], be(), Se(), De(), jr(window, "pagehide", Ie)
            },
            stop: function() {
                oa = [], ca(), Kt(), te(), I(ce), ue.length > 0 && fe(ue[ue.length - 1].event), I(ee), ie(), ve(), ze(), I(me), ge = [], Se(), I(Ee), De(), Ce()
            },
            observe: Le
        }),
        Re = /[^0-9\.]/g;
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "recipe":
                    ...
                    break;
                case "product":
                    rr(5, t[a]), rr(10, t.name), rr(12, t.sku), t.brand && rr(6, t.brand.name);
                    break;
                ...
                case "person":
                    ...
                    break;
                case "offer":
                    rr(7, t.availability), rr(14, t.itemCondition), rr(13, t.priceCurrency), rr(12, t.sku), T(13, Ye(t.price));
                    break;
                case "brand":
                    rr(6, t.name)
            }
    ...
    function qe(e, n) {
        ...
        switch (e.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
                var s = e;
                if (s.host)
                    if (xn(s), "function" === typeof s.constructor && s.constructor.toString().indexOf("[native code]") >= 0) {
                        Pe(s);
                ...
                break;
            case Node.TEXT_NODE:
                if (i = i || e.parentNode, "update" === r || i && Wn(i) && "STYLE" !== i.tagName) {
                    var p = {
                        tag: "*T",
                        value: e.nodeValue
                    };
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (i = e.parentElement ? e.parentElement : e.parentNode ? e.parentNode : null, "http://www.w3.org/2000/svg" === v.namespaceURI && (g = "svg:" + g), g) {
                    ...
                    case "IFRAME":
                        ...
                        In(O) && (! function(t) {
                            !1 === Wn(t) && jr(t, "load", cn.bind(this, t, "childList"), !0)
    ...
    function Be(t) {
        ...
        try {
            ...
            if (Ca(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
                ...
                switch (s.label) {
                    ...
                    case 4:
                        ...
                        switch (o = r.target, u = function(t, e) {
                            ...
                            return t.type
                        }(r, t), u && o && o.ownerDocument && xn(o.ownerDocument), u && o && o.nodeType == Node.DOCUMENT_FRAGMENT_NODE && o.host && xn(o), u) {
                            case "attributes":
                                qe(o, 3);
                                break;
                            case "characterData":
    ...
    function Tn(t, e, n, a) {
        var r, i = _n(t, !0),
            ...
            h = u.content ? 1 : 2;
        o >= 0 && dn[o] && ((s = dn[o]).children.push(i), l = null === l ? s.region : l, d = s.fragment, f = null === f ? s.metadata.fraud : f, h = s.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (Zn(t, n.attributes["data-clarity-region"]), l = i), ln[i] = t, dn[i] = {
                id: i,
                parent: o,
                previous: c,
                children: [],
            ...
            function(t, e, n) {
                ...
                switch (!0) {
                    ...
                    case "INPUT" === u && 0 === i:
                        ...
                        break;
                    case 1 === i && "INPUT" === u:
                        r.privacy = jn(o.class, mn, r), r.privacy = yn.indexOf(o.type) >= 0 ? 0 : i;
                        break;
                    case 1 === i:
                        r.privacy = jn(o.class, mn, r)
                }
            }(t, dn[i], s), Ln(dn[i]), "IMG" === (r = dn[i]).data.tag && 3 === r.metadata.privacy && (r.metadata.size = []), Pn(i, a, dn[i].fragment)
    }
    ...
    function Dn(t, e, n, a) {
        ...
        if (r in dn) {
            ...
            s.fragment && gn[s.fragment] && (u = !0), Ln(s), Pn(r, a, dn[r].fragment, u, c)
        }
    }
    ...
    function Zn(t, e) {
        !1 === Bn.has(t) && (Bn.set(t, e), (Gn = null === Gn && Jn ? new IntersectionObserver($n, {
            threshold: [0, .2, .4, .6, .8, 1]
        }) : Gn) && t && t.nodeType === Node.ELEMENT_NODE && Gn.observe(t))
    }
    ...
    function Qn() {
        for (var t = [], e = 0, n = Fn; e < n.length; e++) {
            var a = n[e],
                r = _n(a.node);
            r in Vn || (r ? (a.data.id = r, Vn[r] = a.data, Un.push(ea(a.data))) : t.push(a))
        }
    ...
    function $n(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            ...
            if (Bn.has(r) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                ...
                ta(r, s, s.interaction, d ? 13 : l ? 10 : 0), s.visibility >= 13 && Gn && Gn.unobserve(r)
            }
        }
        Un.length > 0 && Rt(7)
    }
    ...
    function ta(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in Vn && r || !(e.id in Vn)) && (Vn[e.id] = e, Un.push(ea(e))) : Fn.push({
            node: t,
            data: e
        })
    }
    ...
    function ia(t) {
        return Q(this, void 0, void 0, (function() {
            var e, n, a, r, i, o, u, c, s, d, f, h, p, v, g, b, w, k, E, O, M, S, N, x, _, T, D, I, C;
            return $(this, (function(j) {
                switch (e = l(), n = [e, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (a = 0, r = ue; a < r.length; a++) I = r[a], (i = ra(I.data.target, I.event)).id > 0 && ((n = [I.time, I.event]).push(i.id), n.push(I.data.x), n.push(I.data.y), wa(n), m(I.event, I.data.x, I.data.y));
                        he();
                        break;
                    case 9:
                        for (o = 0, u = Bt; o < u.length; o++) I = u[o], c = ra(I.data.target, I.event, I.data.text), n = [I.time, I.event], s = c.hash.join("."), n.push(c.id), n.push(I.data.x), n.push(I.data.y), n.push(I.data.eX), n.push(I.data.eY), n.push(I.data.button), n.push(I.data.reaction), n.push(I.data.context), n.push(ft(I.data.text, "click", c.privacy)), n.push(I.data.link), n.push(s), n.push(I.data.trust), wa(n), sa(I.time, I.event, s, I.data.x, I.data.y, I.data.reaction, I.data.context);
                        Kt();
                        break;
                    case 38:
                        for (d = 0, f = Qt; d < f.length; d++) I = f[d], n = [I.time, I.event], (_ = ra(I.data.target, I.event)).id > 0 && (n.push(_.id), n.push(I.data.action), wa(n));
                        te();
                        break;
                    case 11:
                        h = oe, n.push(h.width), n.push(h.height), m(t, h.width, h.height), ve(), wa(n);
                        break;
                    case 26:
                        p = Ne, n.push(p.name), Ce(), wa(n);
                        break;
                    case 27:
                        for (v = 0, g = ne; v < g.length; v++) I = g[v], b = ra(I.data.target, I.event, I.data.value), (n = [I.time, I.event]).push(b.id), n.push(ft(I.data.value, "input", b.privacy)), wa(n);
                        ie();
                        break;
                    case 21:
                        (w = we) && (k = ra(w.start, t), E = ra(w.end, t), n.push(k.id), n.push(w.startOffset), n.push(E.id), n.push(w.endOffset), Se(), wa(n));
                        break;
                    case 10:
                        for (O = 0, M = ge; O < M.length; O++) I = M[O], (S = ra(I.data.target, I.event)).id > 0 && ((n = [I.time, I.event]).push(S.id), n.push(I.data.x), n.push(I.data.y), wa(n), m(I.event, I.data.x, I.data.y));
                        ge = [];
                        break;
                    case 39:
                        for (N = 0, x = _e; N < x.length; N++) I = x[N], n = [I.time, I.event], (_ = ra(I.data.target, I.event)).id > 0 && (n.push(_.id), wa(n));
                        De();
                        break;
                    case 22:
                        for (T = 0, D = ua; T < D.length; T++) I = D[T], (n = [I.time, I.event]).push(I.data.type), n.push(I.data.hash), n.push(I.data.x), n.push(I.data.y), n.push(I.data.reaction), n.push(I.data.context), wa(n, !1);
                        ca();
                        break;
                    case 28:
    ...
    function sa(t, e, n, a, r, i, o) {
        void 0 === i && (i = 1), void 0 === o && (o = 0), oa.push({
            time: t,
            event: 22,
            data: {
                type: e,
    ...
    var la, da, fa, ha, pa, va = 0,
        ga = 0,
        ma = null,
        ba = 0;

    function ya() {
        ha = !0, va = 0, ga = 0, ba = 0, la = [], da = [], fa = {}, pa = null
    }
    ...
    function wa(t, e) {
        if (void 0 === e && (e = !0), ha) {
            ...
            n - ba > 2 * i && (I(ma), ma = null), e && null === ma && (25 !== a && L(), ma = D(Ea, i), ba = n, Za(ga))
        }
    }

    function ka() {
        I(ma), Ea(!0), va = 0, ga = 0, ba = 0, la = [], da = [], fa = {}, pa = null, ha = !1
    }
    ...
    function Ea(t) {
        return void 0 === t && (t = !1), Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return ma = null, (e = !1 === u.lean && ga > 0 && (ga < 1048576 || Sr.sequence > 0)) && T(1, 1), Qn(),
                            function() {
                                var t = [];
                                ua = [];
                                for (var e = Sr.start + Sr.duration, n = Math.max(e - 2e3, 0), a = 0, r = oa; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && ua.push(i), t.push(i))
                                }
                                oa = t, ia(22)
                            }(), ot(), n = !0 === t, a = JSON.stringify(_r(n)), r = "[".concat(da.join(), "]"), i = e ? "[".concat(la.join(), "]") : "", o = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return _(2, (c = s) ? c.length : o.length), Oa(o, c, Sr.sequence, n), da = [], e && (la = [], ga = 0, va = 0), [2]
                }
            }))
        }))
    }
    ...
    function Ma(t, e) {
        var n = fa[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Ka(6) : (0 === t.status && (u.upload = u.fallback ? u.fallback : u.upload), Oa(n.data, null, e)) : (pa = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && Ja(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (Oa(n.data, null, e, !0), Ka(3)), t.status >= 200 && t.status <= 208 && Sa(e), delete fa[e]))
    }
    ...
    function _a(t) {
        var e = t.error || t;
        return e.message in xa || (xa[e.message] = 0), xa[e.message]++ >= 5 || e && e.message && (Na = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function Ta(t) {
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(n) {
                switch (e = [l(), t], t) {
                    case 31:
                        e.push(Na.message), e.push(Na.line), e.push(Na.column), e.push(Na.stack), e.push(Na.source), wa(e);
                        break;
                    case 33:
                        Da && (e.push(Da.code), e.push(Da.name), e.push(Da.message), e.push(Da.stack), e.push(Da.severity), wa(e, !1));
                        break;
                    case 41:
                        pt && (e.push(pt.id), e.push(pt.target), e.push(pt.hash), wa(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Ca(t, e, n, a, r) {
        ...
        t in Ia && Ia[t].indexOf(i) >= 0 || (Da = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in Ia ? Ia[t].push(i) : Ia[t] = [i], Ta(33))
    }
    var ja, za = {},
        La = [],
        Aa = {},
    ...
    function Pa(t, e, n) {
        void 0 === n && (n = !1), (!(t in za) || t in za && za[t] !== e || n) && (za[t] = e, La.push(t))
    }
    ...
    function Ja(t) {
        ...
        switch (t) {
            case 4:
                var n = h;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), wa(e, !1)), g();
                break;
            case 25:
                e.push(M.gap), wa(e);
                break;
    ...
    function Za(t) {
        if (0 === ja.check) {
            var e = ja.check;
            e = Sr.sequence >= 128 ? 1 : e, e = l() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== ja.check && Ka(e)
        }
    }
    ...
    function rr(t, e) {
        e && (e = "".concat(e), t in tr || (tr[t] = []), tr[t].indexOf(e) < 0 && (tr[t].push(e), t in er || (er[t] = []), er[t].push(e), tr[t].length > 128 && Ka(5)))
    }
    ...
    function lr() {
        ...
        var t = navigator && "userAgent" in navigator ? navigator.userAgent : "",
            ...
            n = function() {
                ...
                if (e) {
                    var n = e.split("|");
                    n.length >= 5 && t.ts - wr(n[1]) < 18e5 && (t.session = n[0], t.count = wr(n[2]) + 1, t.upgrade = wr(n[3]), t.upload = n.length >= 6 ? "".concat("https://").concat(n[5], "/").concat(n[4]) : "".concat("https://").concat(n[4]))
                }
                return t
            }(),
            a = kr();
        ur = {
            ...
            sessionId: n.session,
            pageNum: n.count
        }, u.lean = u.track && null !== n.upgrade ? 0 === n.upgrade : u.lean, u.upload = u.track && "string" == typeof u.upload && n.upload && n.upload.length > "https://".length ? n.upload : u.upload, rr(0, t), rr(3, e), rr(1, location.href), rr(2, document.referrer), rr(15, function() {
            var t = yr();
            ...
            return t
        }()), rr(16, document.documentElement.lang), rr(17, document.dir), navigator && (rr(9, navigator.userLanguage || navigator.language), navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            rr(22, t.platform), rr(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                rr(24, t.name + "~" + t.version)
            })), rr(25, t.model), T(27, t.mobile ? 1 : 0)
    ...
    function fr(t, e) {
        void 0 === e && (e = !0), ur && !1 === e && t(ur, !u.lean), cr.push({
            callback: t,
            wait: e
        })
    }
    ...
    function gr() {
        ...
        }(n), Or("_clsk", [ur.sessionId, t, ur.pageNum, n, e].join("|"), 1)
    }
    ...
    function br(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e) && Or("_clck", [ur.userId, 1, n.toString(36), e].join("|"), 365)
    }
    ...
    function kr() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 2 && (t.expiry = wr(n[2], 36)), n.length > 3 && 1 === wr(n[3]) && (t.consent = 1), u.track = u.track || 1 === t.consent, t.id = u.track ? n[0] : t.id
        }
        return t
    }
    ...
    function Or(t, e, n) {
        if (u.track && (navigator && navigator.cookieEnabled || mr(document, "cookie"))) {
            var a = new Date;
            ...
            try {
                if (null === sr) {
                    for (var o = location.hostname ? location.hostname.split(".") : [], c = o.length - 1; c >= 0; c--)
                        if (sr = ".".concat(o[c]).concat(sr || ""), c < o.length - 1 && (document.cookie = "".concat(i).concat(";").concat("domain=").concat(sr), Er(t) === e)) return;
                    sr = ""
                }
            } catch (t) {
                sr = ""
            }
            document.cookie = sr ? "".concat(i).concat(";").concat("domain=").concat(sr) : i
        }
    }
    var Mr, Sr = null;
    ...
    function jr(t, e, n, a) {
        void 0 === a && (a = !1), n = Ir(n);
        try {
            t[c("addEventListener")](e, n, a), Cr.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function Ur() {
        Pr = !0, s = performance.now(), Nt(), zr(), Tr(), Rr = qr(), Hr = 0, jr(window, "popstate", Wr), null === Lr && (Lr = history.pushState, history.pushState = function() {
            Lr.apply(this, arguments), Vr() && Yr() && Wr()
        }), null === Ar && (Ar = history.replaceState, history.replaceState = function() {
    ...
    var Gr = Object.freeze({
        __proto__: null,
        start: function() {
            vt = [], T(26, navigator.webdriver ? 1 : 0), jr(window, "error", _a), xa = {}, Ia = {}
        },
        stop: function() {
            Ia = {}
        }
    ...
    var Kr = Object.freeze({
        __proto__: null,
        start: function() {
            Xt(), qt(), na(), Gn = null, Bn = new WeakMap, Vn = {}, Fn = [], Jn = !!window.IntersectionObserver, Mn(),
                function() {
                    if (Fe = [], Qe = [], $e = null, tn = 0, en = {}, null === Ge && (Ge = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                        ...
                        try {
                            Element.prototype.attachShadow = function() {
                                return Vr() ? un(Ke.apply(this, arguments)) : Ke.apply(this, arguments)
                            }
                        } catch (t) {
                            Ke = null
                        }
        ...
        stop: function() {
            na(), Bn = null, Vn = {}, Fn = [], Gn && (Gn.disconnect(), Gn = null), Jn = !1, Sn(),
                function() {
        ...
        $r = {
            ...
            function(t) {
                Q(this, void 0, void 0, (function() {
                    var e, n;
                    return $(this, (function(a) {
                        return e = l(), n = [e, t], 29 === t && (n.push($r.fetchStart), n.push($r.connectStart), n.push($r.connectEnd), n.push($r.requestStart), n.push($r.responseStart), n.push($r.responseEnd), n.push($r.domInteractive), n.push($r.domComplete), n.push($r.loadEventStart), n.push($r.loadEventEnd), n.push($r.redirectCount), n.push($r.size), n.push($r.type), n.push($r.protocol), n.push($r.encodedSize), n.push($r.decodedSize), ti(), wa(n, !1)), [2]
                    }))
                }))
            }(29)
    }
    var ni = ["navigation", "resource", "longtask", "first-input", "layout-shift", "largest-contentful-paint"];
    ...
    function ai() {
        try {
            ...
            for (var t = 0, e = ni; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && _(9, 0), Qr.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        rr(4, ii(r)), r !== u.upload && r !== u.fallback || T(28, a.duration);
                        break;
                    case "longtask":
                        x(7);
                        break;
    ...
    var oi = [Gr, Kr, Ae, Object.freeze({
        __proto__: null,
        start: function() {
            ti(),
                function() {
                    window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? jr(window, "load", D.bind(this, ai, 0)) : ai() : Ca(3, 0)
                }()
        },
        stop: function() {
    ...
    function ui(t) {
        void 0 === t && (t = null),
            function() {
                try {
                    return !1 === Pr && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap
                } catch (t) {
                    return !1
                }
            }() && (Fr(t), Ur(), rt(), oi.forEach((function(t) {
                return Ir(t.start)()
            })))
    }

    function ci() {
        Vr() && (oi.slice().reverse().forEach((function(t) {
            return Ir(t.stop)()
        })), it(), Br())
    }
    var si = Object.freeze({
        ...
        start: ui,
        pause: function() {
            Vr() && (O("clarity", "pause"), null === Mt && (Mt = new Promise((function(t) {
                St = t
            }))))
        },
        resume: function() {
            Vr() && (Mt && (St(), Mt = null, null === Ot && _t()), O("clarity", "resume"))
        },
        stop: ci,
        consent: pr,
        event: O,
